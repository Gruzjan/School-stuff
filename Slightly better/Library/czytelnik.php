...
//jesli znalazlo czytelnika o danym loginie i hasle ustaw typ konta na uzytkownik i odpowiednie dane, jesli nie to szukaj w bibliotekarzach
//jesli to bibliotekarz to odeslij do odpowiedniej strony
    ...
    <main role="main">
        ...
        <div class="py-5">
            ...
            <div class="header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
                <h1 class="display-4"><b id="hr">Zarządzaj kontem</b></h1>
            </div>
